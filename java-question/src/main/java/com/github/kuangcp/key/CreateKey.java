...
public class CreateKey {
  ...
  public String genericPyCharmKey(int minorVersion, int majorVersion, String userName) {
    ...
    return generateKey(privKey, pubKey, LICENSETYPE_NON_COMMERCIAL, PRODUCTID_PyCharm, minorVersion,
        majorVersion, userName);
  }
  ...
  public String genericAppCodeKey(int minorVersion, int majorVersion, String userName) {
    ...
    return generateKey(privKey, pubKey, LICENSETYPE_NON_COMMERCIAL, PRODUCTID_AppCode, minorVersion,
        majorVersion, userName);
  }
  ...
  public String genericPhpStormKey(int minorVersion, int majorVersion, String userName) {
    ...
    return generateKey(privKey, pubKey, LICENSETYPE_NON_COMMERCIAL, PRODUCTID_PhpStorm,
        minorVersion, majorVersion, userName);
  }
  ...
  public String genericRubyMineKey(int minorVersion, int majorVersion, String userName) {
    ...
    return generateKey(privKey, pubKey, LICENSETYPE_NON_COMMERCIAL, PRODUCTID_RubyMine,
        minorVersion, majorVersion, userName);
  }
  ...
  public String genericWebStormKey(int minorVersion, int majorVersion, String userName) {
    ...
    return generateKey(privKey, pubKey, LICENSETYPE_NON_COMMERCIAL, PRODUCTID_WebStorm,
        minorVersion, majorVersion, userName);
  }
}
