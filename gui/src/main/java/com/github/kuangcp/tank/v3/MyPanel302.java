...
public class MyPanel302 extends JPanel implements Runnable {

	JLabel jl1 = null;
	JLabel prizeNo = null;
	MyPanel302 mp =null;
	Hero hero = null;
	Vector<Demons> ets=null;
	
	
	public MyPanel302(JLabel jl1, Hero hero, Vector<Demons> ets, JLabel prizeNo){
		this.jl1 = jl1;
		this.hero = hero;
		this.ets = ets;
...
/**主坦克*/
		...
		//向上
		x=X-10;y=Y-15;//把坦克中心坐标换算成系统用来画坦克的坐标
		//（并且全是取的左上角）
