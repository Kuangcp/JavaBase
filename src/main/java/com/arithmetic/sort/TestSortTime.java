package main.java.com.arithmetic.sort;
...
public class TestSortTime {
	...
	public static void main(String [] args){
		...
		com.arithmetic.sort.GetRunTime time = new com.arithmetic.sort.GetRunTime();
...
//			data.add(new int[MOUNT]);//不能直接写一个new 要有引用指向它
	...
	/**测试快速排序*/
	public static void TestQuick(int [] dat, com.arithmetic.sort.GetRunTime time, boolean display ){
//		if(display){System.out.print("未排序          ");display(dat);}
		time.Start();
		com.arithmetic.sort.Quick.sort(dat,0,dat.length-1);
//		new Quick().quickSort(dat, 0, dat.length-1);
		time.End("\n##quick     :");
		if(display){System.out.println("已排序");display(dat);}
	}
	/**测试冒泡排序*/
	public static void TestBubble(int [] dat, com.arithmetic.sort.GetRunTime time, boolean display ){
//		if(display){System.out.print("未排序          " );display(dat);}
		time.Start();
		com.arithmetic.sort.Bubble.sort(dat);
		time.End("\n##bubble     :");
	...
	/**测试插入排序*/
	public static void TestInsert(int [] dat, com.arithmetic.sort.GetRunTime time, boolean display ){
//		if(display){System.out.print("未排序      ");display(dat);}
		time.Start();
		com.arithmetic.sort.Insert.sort(dat);
		time.End("\n##insert     :");
		//for (int i =0;i<dat.length;i++)
			//System.out.println(dat[i]);
		if(display){System.out.println("已排序");display(dat);}
	...
	/**测试选择排序*/
	public static void TestSelect(int [] dat, com.arithmetic.sort.GetRunTime time, boolean display ){
//		if(display){System.out.print("未排序     ");display(dat);}
		time.Start();
		com.arithmetic.sort.Select.sort(dat);
		//for (int i =0;i<dat.length;i++)
			//System.out.println(dat[i]);
		time.End("\n##select     :");
		if(display){System.out.println("已排序");display(dat);}
	}
	public static void TestShell(int [] dat, com.arithmetic.sort.GetRunTime time, boolean display ){
//		if(display){System.out.print("未排序     ");display(dat);}
		time.Start();
		com.arithmetic.sort.Shell.sort(dat);
		time.End("\n##Shell      :");
		if(display){System.out.println("已排序");display(dat);}
	}
